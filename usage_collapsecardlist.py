...
app.layout = html.Div([
    ...
    html.Div(id='outer', children=dash_blueprint.CollapseCardList(
...
@app.callback(
    ...
    [
        Input('collapse-card-list', 'selected')
    ]
)
...
#                 id='collapse-card-2',
#                 key='2',
#                 # isOpen='2' in (selected or []),
#                 children=[
#                     html.Div('Another header info'),
#                     dash_blueprint.RawCollapse(f'Another collapse thing - {n_intervals}', key=f'{n_intervals}')
#                 ],
#                 interactive=True,
#                 elevation=4
#             ),
