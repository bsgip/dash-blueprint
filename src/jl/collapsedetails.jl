...
export collapsedetails

"""
    collapsedetails(;kwargs...)
    collapsedetails(children::Any;kwargs...)
    collapsedetails(children_maker::Function;kwargs...)
...
"""
function collapsedetails(; kwargs...)
        ...
        return Component("collapsedetails", "CollapseDetails", "dash_blueprint", available_props, wild_props; kwargs...)
end

collapsedetails(children::Any; kwargs...) = collapsedetails(;kwargs..., children = children)
collapsedetails(children_maker::Function; kwargs...) = collapsedetails(children_maker(); kwargs...)
