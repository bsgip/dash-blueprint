...
function daterangeinput(; kwargs...)
        available_props = Symbol[:children, :id, :canClearSelection, :clearButtonText, :date_range, :defaultValue, :end_date, :key, :maxDate, :minDate, :required, :shortcuts, :singleMonthOnly, :start_date, :timePrecision, :todayButtonText, :valid]
        wild_props = Symbol[]
