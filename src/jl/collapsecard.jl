...
function collapsecard(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :autoFocus, :className, :contentEditable, :contextMenu, :dir, :disabled, :draggable, :elevation, :form, :formAction, :hidden, :interactive, :key, :lang, :n_clicks, :n_clicks_timestamp, :name, :role, :spellCheck, :style, :tabIndex, :type, :value]
