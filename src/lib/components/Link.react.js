/**
 * This is a straight copy-paste from the dash core components tool, with one exception - 
 * it stops propagation of the event to parent components.
 * 
 * TODO This portion at least needs to be covered by the MIT license
 */
