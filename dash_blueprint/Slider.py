...
- labelPrecision (number; optional):
    ...
    This prop has no effect if you supply a custom labelRenderer
    callback.

- labelRenderer (boolean; default True):
    Whether to render labels.

- labelStepSize (number; optional):
    Increment between successive labels. Must be greater than zero.

- labelType (string; default 'number'):
    Instructions for rendering the label. Options will be clock, date,
    datetime, number, percentage, etc.
...
- vertical (boolean; default False):
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, key=Component.UNDEFINED, updateKey=Component.UNDEFINED, className=Component.UNDEFINED, disabled=Component.UNDEFINED, initialValue=Component.UNDEFINED, labelPrecision=Component.UNDEFINED, labelType=Component.UNDEFINED, labelStepSize=Component.UNDEFINED, max=Component.UNDEFINED, min=Component.UNDEFINED, stepSize=Component.UNDEFINED, showTrackFill=Component.UNDEFINED, value=Component.UNDEFINED, releaseValue=Component.UNDEFINED, vertical=Component.UNDEFINED, labelRenderer=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'disabled', 'initialValue', 'key', 'labelPrecision', 'labelRenderer', 'labelStepSize', 'labelType', 'max', 'min', 'releaseValue', 'showTrackFill', 'stepSize', 'updateKey', 'value', 'vertical']
        self._type = 'Slider'
        self._namespace = 'dash_blueprint'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'disabled', 'initialValue', 'key', 'labelPrecision', 'labelRenderer', 'labelStepSize', 'labelType', 'max', 'min', 'releaseValue', 'showTrackFill', 'stepSize', 'updateKey', 'value', 'vertical']
