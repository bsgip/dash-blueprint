...
- debounceTimer (number; default 1000):
...
- observeParents (boolean; default False):
    Whether to observe parent sizes.

- size (boolean | number | string | dict | list; optional):
    The current size of the observed e.g. {'x': 0, 'y': 0, 'width':
    884, 'height': 17.265625, 'top': 0,  'right': 884, 'bottom':
    17.265625, 'left': 0} TODO use a proper PropType."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, key=Component.UNDEFINED, observeParents=Component.UNDEFINED, debounceTimer=Component.UNDEFINED, size=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'debounceTimer', 'key', 'observeParents', 'size']
        self._type = 'ResizeSensor'
        self._namespace = 'dash_blueprint'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'debounceTimer', 'key', 'observeParents', 'size']
