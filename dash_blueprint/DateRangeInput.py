...
- shortcuts (boolean; optional): Whether shortcuts to quickly select a range of dates are displayed or not. If true, preset shortcuts will be displayed. If false, no shortcuts will be displayed. If an array is provided, the custom shortcuts will be displayed.
- singleMonthOnly (boolean; optional): Whether to show only a single month calendar.
        ...
        if(any(getattr(self, c, None) is not None
           ...
           or any(getattr(self, c, None) is not None
            ...
            wilds_string = ', '.join([c+'='+repr(getattr(self, c, None))
                                      ...
                                      for wc_attr in
                                      self._valid_wildcard_attributes])])
            return ('DateRangeInput(' + props_string +
