...
- canEscapeKeyClose (boolean; optional): Whether pressing the esc key should invoke onClose.
- captureDismiss (boolean; optional): When enabled, preventDefault() is invoked on click events that close this popover, 
...
- defaultIsOpen (boolean; optional): Initial opened state when uncontrolled.
- enforceFocus (boolean; optional): Whether the overlay should prevent focus from leaving itself. That is, if the user attempts to focus an element outside the overlay and this prop is enabled, then the overlay will immediately bring focus back to itself. If you are nesting overlay components, either disable this prop on the "outermost" overlays or mark the nested ones usePortal={false}.
- hoverCloseDelay (number; optional): The amount of time in milliseconds the tooltip should remain open after the user hovers off the trigger. The timer is canceled if the user mouses over the target before it expires.
- hoverOpenDelay (number; optional): The amount of time in milliseconds the tooltip should wait before opening after the user hovers over the trigger. The timer is canceled if the user mouses away from the target before it expires.
- inheritDarkTheme (boolean; optional): Whether a popover that uses a Portal should automatically inherit the dark theme from its parent.
...
- isOpen (boolean; optional): Whether the popover is visible. Passing this prop puts the popover in controlled mode, where the only way to change visibility is by updating this property. If disabled={true}, this prop will be ignored, and the popover will remain closed.
- lazy (boolean; optional): If true and usePortal={true}, the Portal containing the children is created and attached to the DOM when the overlay is opened for the first time; otherwise this happens when the component mounts. Lazy mounting provides noticeable performance improvements if you have lots of overlays at once, such as on each row of a table.
- openOnTargetFocus (boolean; optional): Whether the popover should open when its target is focused. If true, target will render with tabindex="0" to make it focusable via keyboard navigation.
...
- transitionDuration (number; optional): Indicates how long (in milliseconds) the tooltip's appear/disappear transition takes. This is used by React CSSTransition to know when a transition completes and must match the duration of the animation in CSS. Only set this prop if you override Blueprint's default transitions with new transitions of a different length.
- usePortal (boolean; optional): Whether the popover should be rendered inside a Portal attached to portalContainer prop.
...
- wrapperTagName (string; optional): HTML tag name for the wrapper element, which also receives the className prop."""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, disabled=Component.UNDEFINED, canEscapeKeyClose=Component.UNDEFINED, captureDismiss=Component.UNDEFINED, className=Component.UNDEFINED, content=Component.UNDEFINED, defaultIsOpen=Component.UNDEFINED, enforceFocus=Component.UNDEFINED, hoverCloseDelay=Component.UNDEFINED, hoverOpenDelay=Component.UNDEFINED, inheritDarkTheme=Component.UNDEFINED, intent=Component.UNDEFINED, interactionKind=Component.UNDEFINED, isOpen=Component.UNDEFINED, lazy=Component.UNDEFINED, openOnTargetFocus=Component.UNDEFINED, popoverClassName=Component.UNDEFINED, portalClassName=Component.UNDEFINED, position=Component.UNDEFINED, targetClassName=Component.UNDEFINED, targetProps=Component.UNDEFINED, targetTagName=Component.UNDEFINED, transitionDuration=Component.UNDEFINED, usePortal=Component.UNDEFINED, wrapperTagName=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'key', 'role', 'data-*', 'aria-*', 'disabled', 'canEscapeKeyClose', 'captureDismiss', 'className', 'content', 'defaultIsOpen', 'enforceFocus', 'hoverCloseDelay', 'hoverOpenDelay', 'inheritDarkTheme', 'intent', 'interactionKind', 'isOpen', 'lazy', 'openOnTargetFocus', 'popoverClassName', 'portalClassName', 'position', 'targetClassName', 'targetProps', 'targetTagName', 'transitionDuration', 'usePortal', 'wrapperTagName']
        self._type = 'Tooltip'
        self._namespace = 'dash_blueprint'
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['children', 'id', 'key', 'role', 'data-*', 'aria-*', 'disabled', 'canEscapeKeyClose', 'captureDismiss', 'className', 'content', 'defaultIsOpen', 'enforceFocus', 'hoverCloseDelay', 'hoverOpenDelay', 'inheritDarkTheme', 'intent', 'interactionKind', 'isOpen', 'lazy', 'openOnTargetFocus', 'popoverClassName', 'portalClassName', 'position', 'targetClassName', 'targetProps', 'targetTagName', 'transitionDuration', 'usePortal', 'wrapperTagName']
