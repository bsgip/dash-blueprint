...
- childData (boolean | number | string | dict | list; optional): Collected values of all children of this form group.
...
- collapseChildData (boolean; default False): If `true`, this component assumes there is only one child component that updates
...
to extract single values from objects"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, key=Component.UNDEFINED, label=Component.UNDEFINED, childData=Component.UNDEFINED, className=Component.UNDEFINED, contentClassName=Component.UNDEFINED, disabled=Component.UNDEFINED, helperText=Component.UNDEFINED, inline=Component.UNDEFINED, intent=Component.UNDEFINED, labelFor=Component.UNDEFINED, labelInfo=Component.UNDEFINED, style=Component.UNDEFINED, collapseChildData=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'key', 'label', 'childData', 'className', 'contentClassName', 'disabled', 'helperText', 'inline', 'intent', 'labelFor', 'labelInfo', 'style', 'collapseChildData']
        self._type = 'FormGroup'
        self._namespace = 'dash_blueprint'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'key', 'label', 'childData', 'className', 'contentClassName', 'disabled', 'helperText', 'inline', 'intent', 'labelFor', 'labelInfo', 'style', 'collapseChildData']
