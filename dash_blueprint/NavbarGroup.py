...
- align (string; default 'left'):
    ...
    Alignment enum provides constants for these values. One of
    (`left`, `center`, `right`).
...
- className (string; optional):
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, align=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'align', 'className']
        self._type = 'NavbarGroup'
        self._namespace = 'dash_blueprint'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'align', 'className']
