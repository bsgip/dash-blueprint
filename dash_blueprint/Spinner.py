...
- size (number; optional):
    numberSpinner.SIZE_STANDARD = 50  Width and height of the spinner
    in pixels. The size cannot be less than 10px.  Constants are
    available for common sizes: Spinner.SIZE_SMALL = 20px
    Spinner.SIZE_STANDARD = 50px Spinner.SIZE_LARGE = 100px.
...
- value (number; optional):
    ...
    def __init__(self, id=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, className=Component.UNDEFINED, intent=Component.UNDEFINED, size=Component.UNDEFINED, tagName=Component.UNDEFINED, value=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'aria-*', 'className', 'data-*', 'intent', 'key', 'role', 'size', 'tagName', 'value']
        self._type = 'Spinner'
        self._namespace = 'dash_blueprint'
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['id', 'aria-*', 'className', 'data-*', 'intent', 'key', 'role', 'size', 'tagName', 'value']
