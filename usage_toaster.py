        ...
        dash_blueprint.ButtonGroup(
            ...
            children=[
                dash_blueprint.Button(
                    id="button", children="show some toasts", intent="danger"
                ),
                dash_blueprint.Button(
                    id="button-2", children="show other toasts", intent="primary"
                ),
            ],
        ),
...
@app.callback(Output("first-toaster", "toasts"), [Input("button", "n_clicks")])
...
@app.callback(
    Output("third-toaster-same-as-first", "toasts"), [Input("button-2", "n_clicks")]
)
def button_clicked(n_clicks):
    messages = [
        {
