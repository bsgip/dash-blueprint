...
app.layout = html.Div(
    [
        dash_blueprint.Card(
            id="button", children="some stuff", interactive=True, elevation=4
        ),
        dash_blueprint.Card(
            id="button-2",
            children=[
                dash_blueprint.Collapse(
                    ...
                    children=[
                        dash_blueprint.Button(
                            id="button-9", children="Open Drawer", intent="danger"
                        ),
                        dash_blueprint.Button(
                            id="button-10", children="Create drawer", intent="primary"
                        ),
