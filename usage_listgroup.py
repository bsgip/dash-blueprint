...
app.layout = html.Div([
    ...
    dash_blueprint.Switch(id='switch-2', children='default true switch option', checked=True),
    html.Div(id='output'),
    ...
    dash_blueprint.FormGroup(
        ...
        children=[
            ...
            dash_blueprint.FormGroup(
                ...
                children=[
                    dash_blueprint.Switch(
                        id='chb12', children=html.I('switch 1'), key='c1', className='bp3-inline'
                    ),
                    dash_blueprint.Switch(
