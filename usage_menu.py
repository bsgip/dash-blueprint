...
app.layout = html.Div([
    ...
    dash_blueprint.Menu(
        children=[
            ...
            dash_blueprint.MenuItem(text='', href='something', icon='history', iconSize=64, active=True),
            dash_blueprint.MenuItem(text='Submenu item', icon="history", iconSize=64, active=True, children=[
