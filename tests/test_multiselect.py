...
def test_render_simple_multiselect(dash_duo):
    ...
    dash_duo.wait_for_text_to_equal("#select-output", "you selected ['thing', 'thing-2'], True")
    dash_duo.wait_for_text_to_equal("#formgroup-valid", "True")
    dash_duo.wait_for_text_to_equal("#formgroup-output", "{'multi-select': ['thing', 'thing-2']}")
    ...
    dash_duo.wait_for_text_to_equal("#formgroup-valid", "True")
    dash_duo.wait_for_text_to_equal("#formgroup-output", "{'multi-select': ['thing-2']}")
