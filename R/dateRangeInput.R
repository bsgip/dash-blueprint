...
dateRangeInput <- function(children=NULL, id=NULL, canClearSelection=NULL, clearButtonText=NULL, date=NULL, defaultValue=NULL, end_date=NULL, key=NULL, maxDate=NULL, minDate=NULL, shortcuts=NULL, singleMonthOnly=NULL, start_date=NULL, timePrecision=NULL, todayButtonText=NULL) {
