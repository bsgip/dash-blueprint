...
button <- function(children=NULL, id=NULL, accessKey=NULL, active=NULL, alignText=NULL, autoFocus=NULL, className=NULL, contentEditable=NULL, contextMenu=NULL, dir=NULL, disabled=NULL, draggable=NULL, form=NULL, formAction=NULL, hidden=NULL, href=NULL, icon=NULL, intent=NULL, key=NULL, lang=NULL, large=NULL, minimal=NULL, n_clicks=NULL, n_clicks_timestamp=NULL, name=NULL, rightIcon=NULL, role=NULL, showLoadingOnClick=NULL, small=NULL, spellCheck=NULL, style=NULL, tabIndex=NULL, title=NULL, type=NULL, value=NULL, ...) {
    ...
    component <- list(
        ...
        propNames = c('children', 'id', 'accessKey', 'active', 'alignText', 'autoFocus', 'className', 'contentEditable', 'contextMenu', 'dir', 'disabled', 'draggable', 'form', 'formAction', 'hidden', 'href', 'icon', 'intent', 'key', 'lang', 'large', 'minimal', 'n_clicks', 'n_clicks_timestamp', 'name', 'rightIcon', 'role', 'showLoadingOnClick', 'small', 'spellCheck', 'style', 'tabIndex', 'title', 'type', 'value', wildcard_names),
