...
#' @export
datePicker <- function(children=NULL, id=NULL, canClearSelection=NULL, clearButtonText=NULL, date=NULL, defaultValue=NULL, key=NULL, maxDate=NULL, minDate=NULL, required=NULL, timePrecision=NULL, todayButtonText=NULL, valid=NULL) {
