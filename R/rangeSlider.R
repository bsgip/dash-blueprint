...
rangeSlider <- function(id=NULL, data=NULL, group=NULL, groupSize=NULL, height=NULL, isDate=NULL, margin=NULL, selectSingle=NULL, selected=NULL, width=NULL, yLines=NULL) {
