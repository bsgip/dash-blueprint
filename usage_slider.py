...
app.layout = html.Div([
    ...
    dash_blueprint.Slider(id='slider', initialValue=0, value=-2, min=-10, max=8, stepSize=0.1),
    ...
    dash_blueprint.FormGroup(
        ...
        children=[
            dash_blueprint.Slider(
                id='chb1', children=html.I('slider 1'), key='c1', className='bp3-inline', value=4
            ),
            dash_blueprint.Slider(
                id='chb2', children='slider 2', key='c2', className='bp3-inline', showTrackFill=False
            ),
        ]
    ),
